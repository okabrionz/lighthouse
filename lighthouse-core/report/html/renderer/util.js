...
Util.UIStrings = {
  ...
  /** This label is for a checkbox above a table of items loaded by a web page. This option is used to show all resources in the table. The term `resources` may be elided, as long as it is used in the "exclude" label. */
  thirdPartyResourcesShowLabel: 'Show all',
  /** This label is for a checkbox above a table of items loaded by a web page. The option is used to hide third-party (or "3rd-party") resources in the table, where "third-party resources" refers to items loaded by a web page from URLs that aren't controlled by the owner of the web page. */
  thirdPartyResourcesExcludeLabel: 'Exclude 3rd party',
};
